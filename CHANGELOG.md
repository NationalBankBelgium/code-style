...
- **all:** add `"@types/node": "~14.14.31"` devDependency ([d65683a](https://github.com/NationalBankBelgium/code-style/commit/d65683a18a928dd78cca52ad776b79311ead2802))
- **all:** fix test.sh in order to automatically install missing packages in `npx` cache ([ccc36f9](https://github.com/NationalBankBelgium/code-style/commit/ccc36f9d7c4e7ec6ce7c544e403100f744bf9edd))
- **build:** fix GitHub CI workflow ([72cabbc](https://github.com/NationalBankBelgium/code-style/commit/72cabbcc52f9c4fd8f9b7157b3d5b82ffbf76990))

### Features

- **prettier:** add support for prettier 2.4.x ([33d54b8](https://github.com/NationalBankBelgium/code-style/commit/33d54b84bd00528d22322e4e41906009affe19cc))
- **prettier:** add support for prettier 2.5.x ([94ce6e1](https://github.com/NationalBankBelgium/code-style/commit/94ce6e13641f352053525c8f9138591be2959e7c))
- **prettier:** add support for prettier 2.6.x ([ae5e4ea](https://github.com/NationalBankBelgium/code-style/commit/ae5e4eab5b1475de5ac33def10caf512de4ee2f6))
- **prettier:** add support for prettier 2.7.x ([60a7703](https://github.com/NationalBankBelgium/code-style/commit/60a770398b61d372fc633676caa37ca794f13549))
- **prettier:** add support for prettier 2.8.x ([6cdf1b6](https://github.com/NationalBankBelgium/code-style/commit/6cdf1b6545f62a8235dbe155d3f048215d1ecef3))
- **prettier:** add support for prettier 3.0.x ([5d7b177](https://github.com/NationalBankBelgium/code-style/commit/5d7b17777f3b84ffa2834932c5c1e9c4f206471d))
- **prettier:** add support for prettier 3.1.x ([f924bdc](https://github.com/NationalBankBelgium/code-style/commit/f924bdca9f0f690a0aae37c178652435a1c19575))
