...
- 3.6.x - `@nationalbankbelgium/code-style/prettier/3.6.x`
- 3.7.x - `@nationalbankbelgium/code-style/prettier/3.7.x`
...
```js
module.exports = require("@nationalbankbelgium/code-style/prettier/3.7.x");
```
