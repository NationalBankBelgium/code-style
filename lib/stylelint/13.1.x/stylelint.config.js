module.exports = {
	...
	rules: {
		...
		"at-rule-no-unknown": [
			true,
			{
				ignoreAtRules: ["each", "else", "for", "forward", "function", "if", "include", "mixin", "return", "use"] /* SCSS-specific @-directives */
			}
		],
		"no-descending-specificity": [
			true,
			{
				message: "Disallow selectors of lower specificity from coming after overriding selectors of higher specificity."
			}
		],
